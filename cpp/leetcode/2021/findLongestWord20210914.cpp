...
// 字符串比较大小 #include<string.h>  strcmp(a,b)

// 输入 s = "abpcplea" distionary = ["ale","apple","monkey","plea"] 
// 输出 "apple"
// 返回字典中 最长的字符串 该字符串可以通过删除s中的某些字符得到 答案不止一个 返回长度最长且字典序最小的字符串 不存在返回空
// 小写英文字母组成

string findLongestWord(string s, vector<string>& dictionary) {
    sort(dictionary.begin(), dictionary.end()); // 字节序排序 从小到大
...
{
    string s = "abpcplea";
    vector<string> dictionary = {"plearagfages","apple","ale","ala","monkey"};
